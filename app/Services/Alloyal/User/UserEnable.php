...
class UserEnable
{
    ...
    public function handle($cpf): array
    {
        ...
        Log::channel('alloyal')->debug('Início da ativação de usuário no Alloyal', [
            'cpf' => $cpf,
        ...
        try {
            ...
            if ($response->successful()) {
                Log::channel('alloyal')->info('Usuário ativado com sucesso no Alloyal', [
                    'cpf' => $cpf,
                ...
                Log::channel('alloyal')->warning('Falha na ativação no Alloyal', [
                    'cpf' => $cpf,
                    'status_code' => $response->status(),
            ...
            Log::channel('alloyal')->error('Exceção ao ativar usuário no Alloyal', [
                'cpf' => $cpf,
