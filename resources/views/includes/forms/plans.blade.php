<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-12 col-md-3 p-0 mt-5">
        ...
        <div class="form-group col-12 col-md-3 p-0 mt-5">
            <div class="custom-control custom-switch custom-switch-on-primary d-flex align-items-center"
                style="width: 250px;">
                <input type="checkbox" class="custom-control-input overdue" name="is_active_telemedicine"
                    id="is_active_telemedicine" {{ $plan->is_active_telemedicine ? 'checked' : '' }}>
                <label class="custom-control-label font-weight-normal ml-2"
                    for="is_active_telemedicine">Dependentes</label>
            </div>
        </div>
        ...
        <div class="form-group col-12 col-md-3 p-0 mt-5">
            <div class="custom-control custom-switch custom-switch-on-primary d-flex align-items-center"
                style="width: 250px;">
                <input type="checkbox" class="custom-control-input overdue" name="is_active_alloyal_in_free" id="is_active_alloyal_in_free"
                    {{ $plan->is_active_alloyal_in_free ? 'checked' : '' }}>
                <label class="custom-control-label font-weight-normal ml-2" for="is_active_alloyal_in_free">Liberar Alloyal</label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-12">
            ...
            <div class="input-group">
                <textarea name="description" id="description" class="form-control" required placeholder="Descrição">{{ $plan->description ?? old('description') }}</textarea>
            </div>
        </div>
    </div>
...
<script>
    function getFormData() {
        ...
        formData.append('is_active_alloyal_in_free', $("#is_active_alloyal_in_free").val());
